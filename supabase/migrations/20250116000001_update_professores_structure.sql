-- Script para atualizar a estrutura da tabela professores
-- Remove a tabela antiga se existir e recria com a nova estrutura

-- Dropar políticas existentes primeiro
DROP POLICY IF EXISTS "Permitir leitura pública de professores" ON public.professores;
DROP POLICY IF EXISTS "Permitir inserção para usuários autenticados" ON public.professores;
DROP POLICY IF EXISTS "Permitir atualização para usuários autenticados" ON public.professores;
DROP POLICY IF EXISTS "Permitir deleção para usuários autenticados" ON public.professores;
...
-- Criar tabela professores com a nova estrutura
